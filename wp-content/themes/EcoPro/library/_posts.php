                    ...
                    <div class="post-title fix">
                        ...
                        <div class="metabar">
                            <em>
                                        ...
                                        <?php echo comments_number(0, 1, '%')?> respuestas,
...
<script type="text/javascript">
    cargarverde("/img/caico/caico-cab-noticias.jpg","/img/loopbars/caico-cab-noticias-bg.jpg");
    $j(document).ready(function(){
        jQuery(".page-item-14").addClass("current_page_item");
        jQuery(".page-item-14 img").attr("src",jQuery(".page-item-14 img").attr("src").split("b0-").join("b1-"));
    });
</script>
