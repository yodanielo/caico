<div class="dcontacto">
    <form action="#" method="post" name="frmdccontacto" id="frmdccontacto">
        <div class="dcfila">
            ...
            <input type="text" name="dcnombre" id="dcnombre" class="dcimput" />
        </div>
        <div class="dcfila">
            <div class="dclabel">Apellidos</div>
            <input type="text" name="dcape" id="dcape" class="dcimput" />
        </div>
        <div class="dcfila">
        ...
        <div class="dcfila">
            ...
            <input type="text" name="dctel" id="dctel" class="dcimput" />
        </div>
        <div class="dcfila">
        ...
        <div class="dcfila">
            ...
            <input type="text" name="dcemail" id="dcemail" class="dcimput" />
        </div>
        <div class="dcfila">
            <div class="dclabel" style="width:200px">
                Queremos ser familia activa
            </div>
        </div>
        <div class="dcfila">
            <div class="dclabel" style="width:400px">
                <input name="donando" checked type="radio" value="Donando 400€ anualmente"/>&nbsp;Donando 400€ anualmente<br/>
                <input name="donando" type="radio" value="Donando 200€ anualmente"/>&nbsp;Donando 200€ anualmente<br/>
                <input name="donando" type="radio" value="Donando 100€ anualmente"/>&nbsp;Donando 100€ anualmente<br/>
            </div>
        </div>
        <div class="dcfila">
            <div class="dclabel" style="width:400px">Número de cuenta de cargo</div>
        </div>
        <div class="dcfila">
            <div class="dclabel">Nº de cuenta</div>
            <input type="text" name="dcuenta" id="dcuenta" class="dcimput" />
        </div>
        <div class="dcfila">
