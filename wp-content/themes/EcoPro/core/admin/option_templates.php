...
function pagelines_theme_options() {
	...
	if(VPRO) $intro = '<small><strong>Welcome to '.THEMENAME.' theme options.</strong> This section allows you to customize your theme. <br/>We hope your enjoying this premium theme from <a href="http://www.pagelines.com">PageLines</a>.</small>';
	else $intro = '<small><strong>Welcome to '.THEMENAME.' theme options.</strong> This section allows you to customize your theme.<br/>
	If you\'d like more features; please check out <a href="http://www.pagelines.com/themes/ecopro">EcoPro</a> for tons more templates, options and support.
	</small>';
