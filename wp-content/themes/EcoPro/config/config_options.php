	...
	$default_options = array(
		...
		'custom_code' => array(
				...
				'asynch_analytics' => array(
						...
						'shortexp' => 'Placeholder for Google ssynchroous analytics. Goes underneath "body" tag.',
						'exp' => ""
					),
		...
		$welcome = array(
				...
				'welcome' => array(
						'theme_introduction' => array(
								...
								'<p>PageLines has created tons of features and options for you to take advantage of. Here\'s a few tips to get you started...<br/><small>(Note: This theme intro can be removed below.)</small></p><ul>'.
