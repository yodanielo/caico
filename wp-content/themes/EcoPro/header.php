...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
    <head profile="http://gmpg.org/xfn/11">
        ...
        <?php if((is_page_template('page-feature.php') || is_page_template('page-feature-page.php') || is_page_template('page-feature-blog.php')) && VPRO) require (CORE_INITS.'/init_feature.php');?>
        ...
        <script type="text/javascript" src="http://caico.artesanosdigitales.com/wp-content/themes/EcoPro/custom.js"></script>
    </head>
    <body <?php body_class(); ?>>

        <div style="display:none">
            <a href="http://caico.artesanosdigitales.com/?page_id=16" title="Fotos"><img src="/img/caico/b1-fotos.gif"></a>
            <a href="http://caico.artesanosdigitales.com/?page_id=16" title="Contacto"><img src="/img/caico/b1-contacto.gif"></a>
            <a href="http://caico.artesanosdigitales.com/?page_id=31" title="eventos"><img src="/img/caico/b1-eventos.gif"></a>
            <a href="http://caico.artesanosdigitales.com/?page_id=14" title="Noticias"><img src="/img/caico/b1-noticias.gif"></a>
            <a href="http://caico.artesanosdigitales.com/?page_id=12" title="Colabora"><img src="/img/caico/b1-colabora.gif"></a>
            <a href="http://caico.artesanosdigitales.com/?page_id=10" title="Actividades"><img src="/img/caico/b1-actividades.gif"></a>
            <a href="http://caico.artesanosdigitales.com/?page_id=8" title="Quienes somos"><img src="/img/caico/b1-quienes-somos.gif"></a>
            <a href="http://caico.artesanosdigitales.com" title="Inicio"><img src="/img/caico/b1-inicio.gif"></a>
        </div>
