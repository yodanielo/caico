<?php
    ...
    $mensaje.='<tr><td><strong>Quiero donar parte del programa Actívate</strong></td><td>'.$_GET["quierodonar"].'</td></tr>';
    $mensaje.='<tr><td><strong>Con carácter</strong></td><td>'.$_GET["caracter"].'</td></tr>';
